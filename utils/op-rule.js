...
function addYuanRel(lhsSearchSequnce, rhsSearchSequnce) {
    ...
    // 运算结果序列
    const resultSequnce = [];
    lhsSearchSequnce.forEach((lhsTripleSequnce) => {
        lhsTripleSequnce.forEach((lhsTriple) => {
    ...
    rhsSearchSequnce.forEach((rhsTripleSequnce) => {
        rhsTripleSequnce.forEach((rhsTriple) => {
    ...
    lhsTerminalVarSet.forEach((lhsTerminalVar) => {
        rhsTerminalVarSet.forEach((rhsTerminalVar) => {
