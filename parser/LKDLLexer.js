...
class LKDLLexer extends antlr4_1.Lexer {
    constructor(input) {
        super(input);
        this._interp = new antlr4_1.LexerATNSimulator(this, LKDLLexer._ATN, LKDLLexer.DecisionsToDFA, new antlr4_1.PredictionContextCache());
    }
    get grammarFileName() { return "LKDL.g4"; }
    get literalNames() { return LKDLLexer.literalNames; }
    get symbolicNames() { return LKDLLexer.symbolicNames; }
    get ruleNames() { return LKDLLexer.ruleNames; }
    get serializedATN() { return LKDLLexer._serializedATN; }
    get channelNames() { return LKDLLexer.channelNames; }
    get modeNames() { return LKDLLexer.modeNames; }
    static get _ATN() {
        if (!LKDLLexer.__ATN) {
            LKDLLexer.__ATN = new antlr4_1.ATNDeserializer().deserialize(LKDLLexer._serializedATN);
        }
...
LKDLLexer.DELYUAN = 2;
LKDLLexer.NEWLINE = 3;
LKDLLexer.LINECOMMENT = 4;
LKDLLexer.BLOCKCOMMENT = 5;
LKDLLexer.ASSIGN = 6;
LKDLLexer.EQ = 7;
LKDLLexer.ATTR = 8;
LKDLLexer.ADD = 9;
LKDLLexer.SUB = 10;
LKDLLexer.COMMA = 11;
LKDLLexer.OPEN_BRACKET = 12;
LKDLLexer.CLOSE_BRACKET = 13;
LKDLLexer.OPEN_PAREN = 14;
LKDLLexer.CLOSE_PAREN = 15;
LKDLLexer.ADDEQ = 16;
LKDLLexer.DELEQ = 17;
LKDLLexer.RULEDEF = 18;
LKDLLexer.ISA = 19;
LKDLLexer.HAS = 20;
LKDLLexer.ALL = 21;
LKDLLexer.INT = 22;
...
LKDLLexer.ID = 24;
LKDLLexer.WS = 25;
LKDLLexer.EOF = antlr4_1.Token.EOF;
LKDLLexer.channelNames = ["DEFAULT_TOKEN_CHANNEL", "HIDDEN"];
LKDLLexer.literalNames = [null, "'\\u5143+='",
    "'\\u5143-='",
    null, null,
    null, "'='",
    "'=='", "'.'",
    ...
    null, "'+='",
    "'-='", "':='"];
LKDLLexer.symbolicNames = [null, "ADDYUAN",
    "DELYUAN",
    "NEWLINE",
    "LINECOMMENT",
    "BLOCKCOMMENT",
    ...
    "FLOAT", "ID",
    "WS"];
LKDLLexer.modeNames = ["DEFAULT_MODE",];
LKDLLexer.ruleNames = [
...
LKDLLexer._serializedATN = [4, 0, 25, 186, 6, -1, 2, 0,
...
LKDLLexer.DecisionsToDFA = LKDLLexer._ATN.decisionToState.map((ds, index) => new antlr4_1.DFA(ds, index));
exports.default = LKDLLexer;
