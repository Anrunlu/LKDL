...
LKDLLexer.SUB = 9;
LKDLLexer.COMMA = 10;
LKDLLexer.OPEN_BRACKET = 11;
LKDLLexer.CLOSE_BRACKET = 12;
LKDLLexer.OPEN_PAREN = 13;
LKDLLexer.CLOSE_PAREN = 14;
LKDLLexer.ADDEQ = 15;
LKDLLexer.DELEQ = 16;
LKDLLexer.RULEDEF = 17;
LKDLLexer.RNAME = 18;
LKDLLexer.ADDYUAN = 19;
LKDLLexer.DELYUAN = 20;
LKDLLexer.EOF = antlr4_1.Token.EOF;
LKDLLexer.channelNames = ["DEFAULT_TOKEN_CHANNEL", "HIDDEN"];
LKDLLexer.literalNames = [null, null,
    null, null,
    "';'", null,
    "'='", "'.'",
    "'+'", "'-'",
    ...
    null, "'\\u5143+='",
    "'\\u5143-='"];
LKDLLexer.symbolicNames = [null, "ID",
    "INT", "FLOAT",
    "NEWLINE",
    "WS", "ASSIGN",
    "ATTR", "ADD",
...
LKDLLexer._serializedATN = [4, 0, 20, 145, 6, -1, 2, 0,
